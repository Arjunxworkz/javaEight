...
@Configuration
public class DbConfoguration {

	public DbConfoguration() {
		System.out.println("created"+ this.getClass().getPackageName());
	}
	...
	public DataSource dataSource() {
		...
		driverManagerDataSource.setUrl("jdbc:mysql://localhost:3306/criminals");
